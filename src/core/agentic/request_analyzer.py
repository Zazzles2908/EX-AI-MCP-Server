...
class RequestAnalyzer:
    ...
    def _assess_complexity(self, content_info: Dict[str, Any]) -> ContentComplexity:
        ...
        # Extra boost for very long context
        if tokens > 30000:
            complexity_score += 2
    ...
    def _estimate_tokens(self, text: str) -> int:
        ...
        Heuristic: use ~4 chars/token for small texts; for very long texts
        use a more generous estimate to reflect higher tokenization density.
        """
        ...
        n = len(text)
        if n > 20000:
            # Long content: approximate ~2 chars/token plus a small uplift
            estimated = (n // 2) + (n // 10)
        else:
