...
from .request_handler_init import (
    initialize_request,
    build_tool_registry,
    setup_monitoring_config,
    generate_request_id,
)
from .request_handler_routing import (
    normalize_tool_name,
    check_client_filters,
    suggest_tool_name,
    handle_unknown_tool,
)
from .request_handler_model_resolution import (
    resolve_auto_model_legacy,
    validate_and_fallback_model,
)
from .request_handler_context import (
    reconstruct_context,
    integrate_session_cache,
    auto_select_consensus_models,
)
from .request_handler_monitoring import (
...
# Env helper (imported from init module or fallback)
try:
