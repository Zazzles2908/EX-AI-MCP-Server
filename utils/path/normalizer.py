...
# Phase A2 Cleanup: Removed global instance and convenience functions
# These added unnecessary abstraction. Use PathNormalizer class directly:
#   normalizer = PathNormalizer()
#   success, path, method = normalizer.normalize_for_docker(file_path)
#
# Removed:
# - _normalizer global instance
# - get_normalizer() function
# - normalize_path() convenience function
# - convert_to_linux_path() convenience function
# - convert_to_windows_path() convenience function
#
