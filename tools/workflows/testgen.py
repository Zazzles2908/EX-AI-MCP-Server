...
class TestGenTool(WorkflowTool):
    ...
    def get_description(self) -> str:
        return (
            "COMPREHENSIVE TEST GENERATION - Structured test generation workflow with expert validation.\n\n"
            ...
            "2. YOU call this tool with test scenarios YOU identified\n"
            "3. Tool auto-executes internally (NO AI calls during steps 2-N)\n"
            "4. Tool calls expert analysis at END (ONE AI call for test generation)\n"
            "5. You receive comprehensive test suite with edge cases\n\n"
            "WORKFLOW:\n"
            "Step 1: YOU analyze the code using view/codebase-retrieval\n"
            "  - Understand code paths and business logic\n"
            "  - Identify edge cases and boundary conditions\n"
            "  - Note error handling and failure modes\n"
            "  - Assess async behavior and state management\n"
            "Step 2: Call testgen_EXAI-WS with YOUR findings:\n"
            "  - Describe test scenarios YOU identified\n"
            "  - Include edge cases and failure modes\n"
            "  - Specify relevant files (absolute paths)\n"
            "Step 3: Receive generated tests with comprehensive coverage\n\n"
            "❌ DON'T: Call this tool expecting it to analyze code for you\n"
            "✅ DO: Analyze code first, then use this tool to generate tests based on YOUR analysis\n\n"
