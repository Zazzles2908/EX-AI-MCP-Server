...
class SecauditTool(WorkflowTool):
    ...
    def get_description(self) -> str:
        ...
        return (
            "COMPREHENSIVE SECURITY AUDIT - Structured security assessment with expert validation.\n\n"
            "⚠️ CRITICAL: This tool CANNOT audit security for you! YOU (Claude) must audit FIRST.\n\n"
            "HOW THIS TOOL WORKS:\n"
            "1. YOU audit code using view/codebase-retrieval tools\n"
            "2. YOU call this tool with security issues YOU identified\n"
            ...
            "5. You receive comprehensive security assessment\n\n"
            "WORKFLOW:\n"
            "Step 1: YOU audit the code using view/codebase-retrieval\n"
            "  - Check OWASP Top 10 vulnerabilities\n"
            "  - Review authentication and authorization\n"
            "  - Examine input validation and sanitization\n"
            "  - Assess cryptographic implementations\n"
            "  - Check for security misconfigurations\n"
            "Step 2: Call secaudit_EXAI-WS with YOUR findings:\n"
            "  - List security issues YOU found with severity\n"
            "  - Include specific vulnerable code examples\n"
            "  - Specify relevant files (absolute paths)\n"
            "Step 3: Receive expert validation and remediation guidance\n\n"
            "❌ DON'T: Call this tool expecting it to audit security for you\n"
            "✅ DO: Audit code first, then use this tool to structure findings and get expert validation\n\n"
    ...
    def prepare_step_data(self, request) -> dict:
        ...
        try:
            ...
            raise ValueError(f"[secaudit:security] {e}")
