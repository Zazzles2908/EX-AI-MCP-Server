...
class PrecommitTool(WorkflowTool):
    ...
    def get_description(self) -> str:
        return (
            "COMPREHENSIVE PRE-COMMIT VALIDATION - Structured change validation with expert analysis.\n\n"
            "⚠️ CRITICAL: This tool CANNOT validate changes for you! YOU (Claude) must investigate FIRST.\n\n"
            "HOW THIS TOOL WORKS:\n"
            "1. YOU investigate git changes using git diff and file reading tools\n"
            "2. YOU call this tool with validation findings YOU discovered\n"
            ...
            "5. You receive comprehensive change assessment\n\n"
            "WORKFLOW:\n"
            "Step 1: YOU investigate changes using git tools and view/codebase-retrieval\n"
            "  - Check git status and diff\n"
            "  - Review all modified files\n"
            "  - Identify potential issues or missing changes\n"
            "  - Assess completeness and correctness\n"
            "  - Check for security implications\n"
            "Step 2: Call precommit_EXAI-WS with YOUR findings:\n"
            "  - List issues or concerns YOU found\n"
            "  - Include specific file changes\n"
            "  - Specify repository path\n"
            "Step 3: Receive expert validation and recommendations\n\n"
            "❌ DON'T: Call this tool expecting it to validate changes for you\n"
            "✅ DO: Investigate changes first, then use this tool to structure findings and get expert validation\n\n"
    ...
    def prepare_step_data(self, request) -> dict:
        ...
        try:
            ...
            raise ValueError(f"[precommit:security] {e}")
    ...
    def should_skip_expert_analysis(self, request, consolidated_findings) -> bool:
        """
        Precommit workflow expert analysis decision.
