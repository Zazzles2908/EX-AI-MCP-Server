...
class RefactorTool(WorkflowTool):
    ...
    def get_description(self) -> str:
        return (
            ...
            "⚠️ CRITICAL: This tool CANNOT identify refactoring opportunities for you! YOU (Claude) must analyze FIRST.\n\n"
            "HOW THIS TOOL WORKS:\n"
            ...
            "❌ DON'T: Call this tool expecting it to find refactoring opportunities for you\n"
