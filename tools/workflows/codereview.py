...
class CodeReviewTool(WorkflowTool):
    ...
    def get_description(self) -> str:
        return (
            "COMPREHENSIVE CODE REVIEW - Structured code review workflow with expert validation.\n\n"
            "⚠️ CRITICAL: This tool CANNOT review code for you! YOU (Claude) must review FIRST.\n\n"
            "HOW THIS TOOL WORKS:\n"
            "1. YOU review code using view/codebase-retrieval tools\n"
            "2. YOU call this tool with your findings (bugs, security issues, code smells)\n"
            ...
            "5. You receive comprehensive review with prioritized recommendations\n\n"
            "WORKFLOW:\n"
            "Step 1: YOU review the code using view/codebase-retrieval\n"
            "  - Read the code thoroughly\n"
            "  - Identify bugs, security issues, code smells\n"
            "  - Check error handling, input validation\n"
            "  - Look for performance issues\n"
            "  - Note architectural concerns\n"
            "Step 2: Call codereview_EXAI-WS with YOUR findings:\n"
            "  - List all issues YOU found with severity levels\n"
            "  - Include concrete evidence from code\n"
            "  - Specify relevant files (absolute paths)\n"
            "Step 3: Receive expert validation and additional insights\n\n"
            "❌ DON'T: Call this tool expecting it to review code for you\n"
            "✅ DO: Review code first, then use this tool to structure findings and get expert validation\n\n"
    ...
    def prepare_step_data(self, request) -> dict:
        ...
        try:
            ...
            raise ValueError(f"[codereview:security] {e}")
